...
- 2026-08-29: Repaired Timeline Trip creation on copied production schemas where `trips.id` had lost its UUID default. Startup now restores Trip and Trip-membership defaults, and both normal and imported Trip inserts generate IDs explicitly so album creation cannot submit a null primary key.
