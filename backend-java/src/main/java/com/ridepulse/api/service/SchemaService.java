...
public class SchemaService {
  ...
  private List<String> schemaQueryKeys() {
    return List.of(
        ...
        QueryKeys.SCHEMA_TRIPS_DEFAULTS,
        QueryKeys.SCHEMA_TRIP_RIDES_TABLE,
        QueryKeys.SCHEMA_TRIP_RIDES_DEFAULTS,
        ...
        QueryKeys.SCHEMA_RIDE_DESTINATION_NAME,
        QueryKeys.SCHEMA_RIDE_DESTINATION_CATEGORY,
        QueryKeys.SCHEMA_RIDE_DESTINATION_ADDRESS,
        QueryKeys.SCHEMA_RIDE_DESTINATION_SOURCE,
        QueryKeys.SCHEMA_RIDE_AI_CONTEXT_VERSION,
        ...
        QueryKeys.SCHEMA_TRIP_RIDES_MEMBERSHIP_INDEX,
        ...
        QueryKeys.SCHEMA_RIDES_SOURCE,
        QueryKeys.SCHEMA_RIDES_SOURCE_ACTIVITY_TYPE,
        QueryKeys.SCHEMA_RIDES_SPEED_DATA_QUALITY,
        QueryKeys.SCHEMA_RIDES_SOURCE_BACKFILL,
        QueryKeys.SCHEMA_RIDES_SOURCE_NOT_NULL,
        QueryKeys.SCHEMA_RIDES_CLIENT_ID_INDEX,
        QueryKeys.SCHEMA_TRIPS_CLIENT_ID,
        QueryKeys.SCHEMA_TRIPS_CLIENT_ID_INDEX);
  }
}
